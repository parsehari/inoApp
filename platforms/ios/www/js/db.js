    ...
    createTable: function() {
        ...
        this.db.transaction(
                            ...
                            var sql ="CREATE TABLE IF NOT EXISTS DeliveryPickup ( OrderNo TEXT, LineNo TEXT, ItemId TEXT, Item TEXT, Description TEXT, MaterialGrp TEXT, MaterialDesc TEXT, ExpectedQty NUMBER, ConfirmedQty NUMBER,BatchQty NUMBER DEFAULT 0,Type TEXT, Hours TEXT, PickupComments TEXT, IsAdded TEXT, flag TEXT, newlyAdded TEXT, PRIMARY KEY(OrderNo,ItemId,Type))";
                            tx.executeSql(sql);
